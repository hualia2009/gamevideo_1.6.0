...
public class AppItemView {
	...
	public View getAdapterView(final Context context, final AdInfo adInfo, int itemWidth, int itemHeight){
		...
		try {
			...
			int item_whole_bg_id = context.getResources().getIdentifier("group_bg", "drawable", context.getPackageName());
...
//			d_layout.setBackgroundColor(Color.parseColor("#AAFFD700"));
			...
			Drawable divider_line = content.getResources().getDrawable(R.drawable.dividerline);
			line_layout_2.setBackgroundDrawable(divider_line);
...
//			r_layout.addView(l_layout);
			...
			whole_layout.setBackgroundResource(R.drawable.group_bg);
